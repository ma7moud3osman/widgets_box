...
/// Legacy single-_debounceTimer debouncer kept for backwards compatibility. Note that it
/// shares one global _debounceTimer across all call sites, so concurrent debounced
